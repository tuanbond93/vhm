...
export function Footer() {
  return (
    <footer className="w-full bg-white border-t border-slate-200/90 pt-16 pb-20 md:pb-12 text-slate-600 text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 pb-12 border-b border-slate-200">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <Link href="/kien-thuc" className="hover:text-blue-600 transition-colors">
                  Bài viết Kiến thức
                </Link>
              </li>
              <li>
                <Link href="/cong-cu" className="hover:text-blue-600 transition-colors">
                  Tools & AI Prompt Kit
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-3 bg-slate-50 p-4 rounded-xl border border-slate-200/80">
            <h4 className="font-heading font-bold text-blue-700 text-xs uppercase tracking-wider">
              Định hướng V1
            </h4>
            <p className="text-xs text-slate-600 leading-relaxed">
              Trang web tập trung vào kiến thức, tài nguyên và công cụ thực tế. Không phô trương, không ảo tưởng công nghệ.
            </p>
          </div>
