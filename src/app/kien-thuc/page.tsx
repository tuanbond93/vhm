  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-12">
      ...
      <div className="max-w-3xl space-y-4">
        ...
        <h1 className="text-3xl sm:text-5xl font-bold text-slate-900 font-heading tracking-tight">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-slate-200">
        ...
        <div className="relative w-full sm:w-64">
          <input
            ...
            className="w-full bg-white border border-slate-300 rounded-xl pl-9 pr-4 py-2.5 text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600"
          />
        ...
        {ARTICLES_DATA.map((article) => (
          ...
          >
            <div className="space-y-4">
              ...
              <h2 className="text-xl font-bold text-slate-900 hover:text-blue-600 transition-colors leading-snug">
      ...
      <div className="bg-slate-100 border border-slate-200/80 p-6 rounded-2xl text-center max-w-2xl mx-auto space-y-2">
