  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 space-y-16">
      ...
      <div className="max-w-3xl space-y-6">
        ...
        <h1 className="text-3xl sm:text-5xl font-bold text-slate-900 font-heading tracking-tight leading-tight">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-white border border-slate-200/90 p-8 sm:p-12 rounded-3xl shadow-sm">
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-slate-900">
            Định vị cốt lõi
          </h2>
          <blockquote className="text-lg font-bold text-blue-700 border-l-4 border-blue-600 pl-4 py-1 italic">
        ...
        <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 space-y-3 font-mono text-xs text-slate-200">
          <div className="text-blue-400 font-bold">// Khung năng lực Operations V1</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {principles.map((item, i) => (
            <div key={i} className="card-surface p-6 space-y-3">
              <div className="p-2.5 w-fit rounded-xl bg-blue-50 border border-blue-200">
                {item.icon}
              </div>
      ...
      {/* CTA Box */}
      <div className="bg-slate-900 border border-slate-800 p-8 rounded-3xl text-center space-y-4 text-white">
        ...
        <div>
          <Link
            href="/cong-cu"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-3 rounded-xl text-sm transition-all shadow-sm"
          >
