...
export const RADAR_ITEMS: RadarItem[] = [
  {
    ...
    type: 'Workforce / Capacity Planning',
    title: 'Cân bằng lao động cố định và linh hoạt: Đường cong học tập thay đổi bài toán nhân sự kho hàng như thế nào?',
    subtitle: 'Phân tích từ nghiên cứu công bố trên tạp chí Transportation Research Part E (Auad et al., 2026) về bài toán phối hợp lực lượng lao động cố định và linh hoạt dưới giới hạn đường cong học tập.',
    summary: 'Nghiên cứu trên Transportation Research Part E (2026) chỉ ra rằng lao động linh hoạt có đường cong học tập theo tác vụ. VHM khuyến nghị nguyên lý Cân bằng Nhân sự Cố định & Linh hoạt trong Giới hạn Đường cong Học tập và quản trị theo Năng lực Sản xuất Thực tế thay vì số lượng đầu người.',
    verdict: 'TEST',
    verdictLabel: 'TEST IN CONTROLLED WORKFLOW',
    verdictDescription: 'Áp dụng nguyên lý Cân bằng Nhân sự Cố định & Linh hoạt trong Giới hạn Đường cong Học tập (Balance Permanent & Flex Labor under Learning Curve Constraints). Thử nghiệm phối hợp nhân sự theo năng lực thực tế trong khu vực kiểm soát.',
    evidenceTitle: 'Balancing flex and non-flex labor to reliably meet on-demand capacity',
    evidenceAuthors: 'Ramon Auad, Thomas Fillebeen, Roman Levkin, Arkajit Rakshit, Martin Savelsbergh',
    evidenceUrl: 'https://doi.org/10.1016/j.tre.2026.104696',
    evidenceTier: 'Tier 1 / Primary Research',
    confidence: 'High',
    publishedAt: '2026-08-10',
    readTime: '9 phút đọc',
    topics: ['Workforce Operations', 'Flex Labor', 'Learning Curve', 'Capacity Planning'],
    operatorKeyInsight: 'Headcount không đồng nghĩa với Năng lực Sản xuất Thực tế; lao động linh hoạt cần tích lũy ca làm việc để tiệm cận năng suất của nhân sự cố định.',
    published: true,
  },
  {
    id: 'radar-007',
    slug: 'ai-dinh-tuyen-dong-chang-giao-van',
    type: 'AI / Transportation Operations',
    title: 'Định tuyến động chặng giao vận: Khi nào AI nên tự động tái định tuyến dưới biến động giao thông?',
    subtitle: 'Phân tích từ nghiên cứu công bố trên tạp chí Transportation Research Part E (Basso et al., 2022) về mô hình Safe DRL định tuyến xe điện động dưới bất định nhu cầu và năng lượng tiêu thụ.',
    summary: 'Nghiên cứu trên Transportation Research Part E (2022) minh chứng mô hình Safe DRL có thể định tuyến xe điện động và kiểm soát nguy cơ cạn pin thông qua Cổng kiểm tra Giới hạn Khả thi Vận hành. VHM khuyến nghị nguyên lý Dự báo -> Ra quyết định -> Tái định tuyến trong Giới hạn Khả thi.',
    verdict: 'TEST',
    verdictLabel: 'TEST IN CONTROLLED WORKFLOW',
    verdictDescription: 'Áp dụng nguyên lý Dự báo -> Ra quyết định -> Tái định tuyến trong Giới hạn Khả thi Vận hành (Predict -> Decide -> Re-route under Feasibility Constraints). Thử nghiệm tái định tuyến trong khu vực kiểm soát.',
    evidenceTitle: 'Dynamic stochastic electric vehicle routing with safe reinforcement learning',
    evidenceAuthors: 'Rafael Basso, Balázs Kulcsár, Ivan Sanchez-Diaz, Xiaobo Qu',
    evidenceUrl: 'https://doi.org/10.1016/j.tre.2021.102496',
    evidenceTier: 'Tier 1 / Primary Research',
    confidence: 'High',
    publishedAt: '2026-08-10',
    readTime: '9 phút đọc',
    topics: ['Transportation Operations', 'Dynamic Routing', 'Safe Reinforcement Learning', 'EV Logistics'],
    operatorKeyInsight: 'Trí tuệ vận hành đạt sức mạnh lớn nhất khi chuyển từ dự báo rủi ro (Cấp độ 2) sang tự động hóa ra quyết định chuỗi trong giới hạn an toàn khả thi (Cấp độ 3).',
    published: true,
  },
  {
    id: 'radar-006',
